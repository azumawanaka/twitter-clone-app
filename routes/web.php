...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/home/tweet/{commentId}/update', [App\Http\Controllers\HomeController::class, 'updateComment'])->name('tweet.comment.update');
    Route::get('/home/tweet/{commentId}/remove', [App\Http\Controllers\HomeController::class, 'removeComment'])->name('tweet.comment.remove');
